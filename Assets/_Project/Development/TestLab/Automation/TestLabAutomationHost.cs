...
namespace UnityIsekaiGame.Development.Automation
{
    ...
    {
        private const TestLabRuntimeArea HostlessFreshRuntimeAreas = TestLabRuntimeArea.KnowledgeHistory | TestLabRuntimeArea.Items | TestLabRuntimeArea.Professions;
    ...
    public sealed class TestLabSceneIndependentAutomationHost : ITestLabAutomationHost
    {
        ...
        public TestLabAutomationHostCapabilities GetCapabilities()
        {
            return new TestLabAutomationHostCapabilities(
                ...
                "scene.none",
                TestLabRuntimeArea.KnowledgeHistory | TestLabRuntimeArea.Items | TestLabRuntimeArea.Professions,
                TestLabRuntimeArea.KnowledgeHistory | TestLabRuntimeArea.Items | TestLabRuntimeArea.Professions,
