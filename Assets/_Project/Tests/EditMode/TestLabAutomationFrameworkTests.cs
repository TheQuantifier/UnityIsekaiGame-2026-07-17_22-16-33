...
namespace UnityIsekaiGame.Tests
{
    public sealed class TestLabAutomationFrameworkTests
    {
        ...
        public void DefaultPrototypeSuites_RegisterStep3ThroughStep13()
        {
            ...
            Assert.That(actualSuiteIds.Last(), Is.EqualTo("feature.13.3.organizational-roles-permissions-authority"));
