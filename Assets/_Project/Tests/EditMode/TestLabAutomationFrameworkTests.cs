...
namespace UnityIsekaiGame.Tests
{
    public sealed class TestLabAutomationFrameworkTests
    {
        ...
        [Test]
        public void DefaultPrototypeSuites_RegisterStep3ThroughStep15()
        {
            ...
            Assert.That(actualSuiteIds.Last(), Is.EqualTo("feature.15.10.quest-chains-narrative-arcs-dependencies-reactive-orchestration"));
