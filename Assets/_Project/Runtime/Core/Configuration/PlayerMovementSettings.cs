...
namespace UnityIsekaiGame.Configuration
{
    ...
    public sealed class PlayerMovementSettings : ScriptableObject
    {
        ...
        [SerializeField, Range(1f, 2f)] private float sprintSpeedMultiplier = 1.6f;
        [SerializeField, HideInInspector, Min(0f)] private float sprintSpeed = 8f;
        ...
        public float SprintSpeedMultiplier => Mathf.Clamp(sprintSpeedMultiplier > 0f ? sprintSpeedMultiplier : walkSpeed > 0f ? sprintSpeed / walkSpeed : 1f, 1f, 2f);
        ...
        private void OnValidate()
        {
            ...
            sprintSpeedMultiplier = Mathf.Clamp(sprintSpeedMultiplier > 0f ? sprintSpeedMultiplier : walkSpeed > 0f ? sprintSpeed / walkSpeed : 1f, 1f, 2f);
