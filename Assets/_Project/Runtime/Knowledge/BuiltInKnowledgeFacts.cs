...
{
    public static class BuiltInKnowledgeFacts
    {
        public const string SpeciesIdentity = "fact.species.identity";
        ...
        public const string CompatibilityResistance = "fact.compatibility.resistance";
        public const string PersonIdentity = "fact.person.identity";
        public const string EventOccurred = "fact.event.occurred";
    }
}
