...
namespace UnityIsekaiGame.Editor
{
    public static class PrototypeSceneUsabilitySetup
    {
        ...
        private const string MaterialsRoot = "Assets/_Project/Presentation/Materials/PrototypeUsability";
        ...
        {
            ItemDefinition potion = Load<ItemDefinition>("Assets/_Project/Prototype/Content/Items/HealthPotion.asset");
            ItemDefinition ore = Load<ItemDefinition>("Assets/_Project/Prototype/Content/Items/PrototypeIronOre.asset");
            ItemDefinition sword = Load<ItemDefinition>("Assets/_Project/Prototype/Content/Items/PrototypeSword.asset");
            ItemDefinition helmet = Load<ItemDefinition>("Assets/_Project/Prototype/Content/Items/PrototypeHelmet.asset");
        ...
        {
            StatusEffectDefinition might = Load<StatusEffectDefinition>("Assets/_Project/Prototype/Content/StatusEffects/PrototypeMightStatus.asset");
            StatusEffectDefinition weakened = Load<StatusEffectDefinition>("Assets/_Project/Prototype/Content/StatusEffects/PrototypeWeakenedStatus.asset");
        ...
        private static void CreateTestPoint(Transform parent, string id, string displayName, Vector3 position, float yaw)
        {
            ...
            serializedSpawn.FindProperty("place").objectReferenceValue = id == "test-point.investigation-area"
                ? Load<PlaceDefinition>("Assets/_Project/Content/Places/DisturbanceSitePlace.asset")
                : null;
        ...
        {
            DefinitionCatalog catalog = Load<DefinitionCatalog>("Assets/_Project/Prototype/Content/GameData/PrototypeDefinitionCatalog.asset");
        ...
        {
            if (!AssetDatabase.IsValidFolder("Assets/_Project/Presentation/Materials"))
            {
            ...
            {
                AssetDatabase.CreateFolder("Assets/_Project/Presentation/Materials", "PrototypeUsability");
            }
        }
    }
}
