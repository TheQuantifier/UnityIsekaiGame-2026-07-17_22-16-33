...
- persistent long-term growth belongs to Attributes;
...
- a new required player-scoped participant, `player.attributes`, owns Attribute persistence;
...
- after load, `player.identity-progression` restores identity records, `player.attributes` restores Attribute sources/events, and vitals/statuses restore after derived stats are available.
