...
The command registers a scene-independent batch host for fixture-owned Knowledge, History, and Item automation. Character, Combat, Biology, Persistence, or UI scenarios that require a live Prototype scene host should still be run through the in-game Test Lab runner unless an explicit editor-capable scene host is added later.
